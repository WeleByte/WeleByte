    ...
    return (
        <div id="addPatientsWrapper" className="shadow-lg">
            ...
            <div id="addPatientsInner">
                ...
                <h5 className="pt-3 px-4 mt-2 mb-3 " style={{textAlign: "left"}}>Preporuku za
                    bolovanje {/* <button className='btn btn-tertiary mt-1' style={{float: 'right'}}>Povijest </button>  */}
                        ...
                        <div style={{display: "grid", gridTemplateColumns: "1fr", gridColumnGap: "20px"}} class="mt-4">
                            ...
                            <div className="mb-3">
                                <label htmlFor="username" className=" col-12 text-label"
                                       style={{float: 'left', textAlign: "left"}}>Pregled</label>
                                <p style={{textAlign: "left"}} class="text">21.12.2023 - Pregled štitnjače - Johny
                                    Smith</p>
                            </div>
                        </div>
