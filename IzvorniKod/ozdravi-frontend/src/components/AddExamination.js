...
const AddExamination = ({closeAddExamination}) => {
...
var finalUsersList = filteredUsers.map((user) =>
  ...
  return (
    ...
    <h5 className = "pt-3 px-4 mt-2 mb-4 " style={{textAlign: "left"}}>Dodaj pregled {/* <button className='btn btn-tertiary mt-1' style={{float: 'right'}}>Povijest </button>  */} <img style={{ height: "23px", float: "right" }} onClick = {closeModal} src={CloseIcon}></img>  </h5>
...
<img src= {searchIcon} className = "searchIconAddPatient" ></img>
  <input type="text" className="form-control me-0 searchInput" onChange={filterPatients} style = {{ borderTopRightRadius: "7px", borderBottomRightRadius: "7px", }} placeholder="Ime pacijenta.." aria-label="Recipient's username" aria-describedby="basic-addon2" ></input>
