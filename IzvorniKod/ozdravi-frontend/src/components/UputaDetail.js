                    ...
                    <div className='px-4 pt-0'>
                        <form >
                            ...
                            <div style={{display: "grid", gridTemplateColumns: "1fr", gridColumnGap: "20px"}} class ="mt-4">
                                ...
                                <div className="mb-3">
                                    <label htmlFor="instruction-patient" className=" col-12 text-label" style={{float: 'left', textAlign:"left"}}>Pacijent </label>
                                    <p style={{textAlign:"left"}} className="text">{instruction.patient.first_name + " " + instruction.patient.last_name}</p>
                                </div>
                                <div className="mb-3">
                                    <label htmlFor="instruction" className=" col-12 text-label" style={{float: 'left', textAlign:"left"}}>Uputa</label>
                                    <p style={{textAlign:"left"}} className ="text">{instruction.content}</p>
                                </div>
                                <div className="mb-3">
                                    <label htmlFor="instruction-date" className=" col-12 text-label" style={{float: 'left', textAlign:"left"}}>Vrijeme izdavanja</label>
                                    <p style={{textAlign:"left"}} className ="text">{instruction.date ? formatDateString(instruction.date) : null}</p>
                                </div>
