\chapter{Implementacija i korisničko sučelje}
		...
		\section{Ispitivanje programskog rješenja}
			...
			Očekivani rezultat:
			\begin{packed_item}
				\item Kontroler u JSON formatu vraća atribute novostvorene Upute, HTTP odgovor ima status 201 (OK).
			\end{packed_item}
			...
			Očekivani rezultat:
			\begin{packed_item}
				\item Kontroler u JSON formatu vraća atribute novostvorenog Korisnika, HTTP odgovor ima status 201 (OK).
			\end{packed_item}
