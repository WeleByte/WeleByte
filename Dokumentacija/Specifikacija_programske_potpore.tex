			...
			\subsection{Obrasci uporabe}
				...
				\subsubsection{Opis obrazaca uporabe}
					...
					\begin{packed_item}
						...
						\item  \textbf{Sudionici:} baza podataka
						\item  \textbf{Preduvjet:} izvođenje UC2 i UC18, korisnik ima dijete
						\item  \textbf{Opis osnovnog tijeka:}
					...
					\begin{packed_item}
						...
						\item  \textbf{Sudionici:} baza podataka
						\item  \textbf{Preduvjet:} izvođenje UC2 i UC6
						\item  \textbf{Opis osnovnog tijeka:}
                    ...
                    \noindent \underbar{\textbf{UC8 - prijavi pacijenta u svoju ordinaciju }}
					\begin{packed_item}
					...
					\begin{packed_item}
						...
						\item[] \begin{packed_enum}
							...
							\item pedijatar unosi e-mail adresu na koju je potrebno poslati ispričnicu
						...
						\item[] \begin{packed_item}
                            ...
                            \item[6.a] pedijatar je neispravno popunio ispričnicu
							\item[] \begin{packed_enum}
					...
					\end{packed_item}
                     ...
                     \noindent \underbar{\textbf{UC14 - donesi odluku o preporuci za bolovanje}}
					\begin{packed_item}
					...
					\begin{packed_item}
						...
						\item[] \begin{packed_enum}
							...
							\item aministrator odabire opciju 'novi registar djeteta'
							\item sustav prikazuje modalni okvir za stvaranje djetetova registra
							\item administrator unosi podatke o djetetu
					...
					\begin{packed_item}
						...
						\item  \textbf{Sudionici:} baza podataka
						\item  \textbf{Preduvjet:} izvođenje UC1 i UC2
						\item  \textbf{Opis osnovnog tijeka:}
