\chapter{Arhitektura i dizajn sustava}
		...
		Glavna tehnologija izrade fronten dijela sustava je React.js razvojni okvir, a samo korisničko sučelje je izgrađeno od gotovih komponenti iz paketa "Bootstrap". Korištenje Bootstrap-a omogućuje brzo i lako razvijanje sučelja koja izgledaju moderno i koja su responzivna, 
